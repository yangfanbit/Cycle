#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""validate_structural_analogy_v0_4.py —— Structural Analogy v0.4 **两层独立校验**（只读）。
...
用法：python research/scripts/validate_structural_analogy_v0_4.py
"""
...
R4P = os.path.join(REP, "structural_analogy_research_v0_4.json")
E4P = os.path.join(REP, "structural_analogy_explanations_v0_4.json")
...
def main():
    ...
    # A9 provenance
    if e4.get("contract", {}).get("source_artifact") != "research/research/reports/structural_analogy_research_v0_4.json":
    ...
    # A10 forbidden
    for nm, obj in (("research_v0_4", r4), ("explanations_v0_4", e4)):
...
def report(r4=None, e4=None, n_checked=0, n_drv=0, mism=0):
    print("=== validate_structural_analogy_v0_4.py（两层独立校验）===")
    if r4:
        s = r4["summary"]
