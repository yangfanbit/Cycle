"""Historical Driver Canonicalization v0.2（deterministic，只读）。

**与 v0.1 的关系**：**规则、词表、mapping_status 语义完全不变**；
**唯一差异 = 覆盖范围** —— v0.1 生成时 export 仅有 17 个历史 cycle；
R01-01~R01-06 完成后 export 已有 79 个（52 campaigns + 27 research_candidates），
本版本在**同一套规则**下重新执行，使 canonical driver 覆盖全部历史 universe。
★ v0.1 产物**逐字节保留**，本版本写入独立文件。
...
OUT_CANON = f"{REP}/historical_driver_canonicalization_v0_2.json"
OUT_LEDGER = f"{REP}/historical_driver_evidence_ledger_v0_2.json"
...
canon_doc = {
    "artifact": "historical_driver_canonicalization", "artifact_version": "0.2",
    "generated_by": "research/scripts/canonicalize_historical_drivers_v0_2.py",
...
ledger_doc = {
    "artifact": "historical_driver_evidence_ledger", "artifact_version": "0.2",
    "generated_by": "research/scripts/canonicalize_historical_drivers_v0_2.py",
