import type { HistoricalCampaign } from '../../src/models';
 ...
 * 3. 每条记录的 evidence_id 可追溯。
 *
 * 当前：0 条。
 * "缺少数据"是合法状态——不得为了填充 verified 层而编造历史事实。
 * 3 条 Pilot 规律（汽车 / 广电 / 大消费）完成人工核验后，记录从
 * data/candidate/campaigns.ts 迁入此处，并在 CHANGELOG.md 留痕。
 */
