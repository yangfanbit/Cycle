...
| `candidate/` | 未经核验的候选知识：候选规律（rules + timeWindows）、材料提及的候选行情（campaigns）、题材分类与事件日历（themes / events，中性参考表，未经过核验流程） | V1 种子数据整体迁入 |
| `verified/` | 已人工核验的历史事实（L2） | **空**。录入标准见 docs/HISTORICAL_VALIDATION.md |
