# R01-02-semiconductor — ThreeC Historical Research Worker Workspace

> **task_id**: `R01-02` · **research_round_id**: `R01` · **status**: `PREPARED_NOT_STARTED`
...
它对应 `R01` 轮次中的任务 **`R01-02`**：半导体 / 电子（含设计、制造、封测、设备、材料、被动元件、面板）
