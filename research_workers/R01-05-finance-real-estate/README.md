# R01-05-finance-real-estate — ThreeC Historical Research Worker Workspace

> **task_id**: `R01-05` · **research_round_id**: `R01` · **status**: `PREPARED_NOT_STARTED`
...
它对应 `R01` 轮次中的任务 **`R01-05`**：金融 / 地产（含银行、券商、保险、多元金融、房地产开发、建材、建筑装饰）
