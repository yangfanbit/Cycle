# R01-03-resources — ThreeC Historical Research Worker Workspace

> **task_id**: `R01-03` · **research_round_id**: `R01` · **status**: `PREPARED_NOT_STARTED`
...
它对应 `R01` 轮次中的任务 **`R01-03`**：资源 / 有色 / 化工（含工业金属、贵金属、稀有金属、能源金属、基础化工、农化）
