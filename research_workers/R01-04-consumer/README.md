# R01-04-consumer — ThreeC Historical Research Worker Workspace

> **task_id**: `R01-04` · **research_round_id**: `R01` · **status**: `PREPARED_NOT_STARTED`
...
它对应 `R01` 轮次中的任务 **`R01-04`**：消费（含食品饮料、白酒、家电、纺服、商贸零售、餐饮旅游、农业）
